...
Features
Implementation of a MultiThreading simulator with Blocked MT and Fine MT configurations.
Input handling for threads with instructions.
Context switch functionality.
Execution of threads using the runthread function.
Output of register states and CPI statistics.
